...
module RISCV_CORE_TEST #(
    ...
    // For verif
    // ----- ----- ----- ----- ----- -----
    output wire [`DW_VERI_DAT    -1:0]                  verification_sig_dat,
    output wire [`DW_VERI_REQ    -1:0]                  verification_sig_req,
    output wire [`DW_VERI_REQEXT -1:0]                  verification_sig_reqext
);
...
assign verification_sig_dat    = {`DW_VERI_DAT{1'b0}};
assign verification_sig_req    = {`DW_VERI_REQ{1'b0}};
assign verification_sig_reqext = {`DW_VERI_REQEXT{1'b0}};
endmodule
